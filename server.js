      ...
      config: {
        ...
        response: {
          schema: {
            ...
            source_url: Joi.any().valid(process.env.SOURCEURL).required(),
            email: Joi.string().email().required(),
            country: Joi.string().allow(''),
  ...
  server.register([
    ...
    },
    {
      ...
      options: {
        ...
        fontSrc: ['self', 'https://fonts.gstatic.com', 'https://maxcdn.bootstrapcdn.com', 'https://code.cdn.mozilla.net', 'https://pontoon.mozilla.org'],
        childSrc: ['https://pontoon.mozilla.org', 'https://app.optimizely.com', 'https://www.thinglink.com'],
        ...
        styleSrc: ['self', 'unsafe-inline', 'https://fonts.googleapis.com', 'https://code.cdn.mozilla.net', 'https://maxcdn.bootstrapcdn.com', 'https://pontoon.mozilla.org'],
